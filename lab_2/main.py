...
# x_inp, y_inp = int(input("Enter number X: ")), int(input("Enter number Y: "))
# print(y_inp, x_inp) if x_inp > y_inp else print(x_inp, y_inp)
# print("---")
...
# inp = int(input("Enter number less than 20: "))
# print("Too high") if inp >= 20 else print("Thanks")
# print("---")
...
# inp = int(input("Enter number from 10 to 20 (included): "))
# print("Thank you") if 10 <= inp <= 20 else print("Incorrect answer")
# print("---")
...
# inp = input("Enter favorite color: ")
# print("I like red too") if inp.lower() == "red" else print(f"I don't like {inp}, I prefer red")
# print("---")
...
is_rainy_inp = input("Is it rainy outside? ")
if is_rainy_inp.lower() == "yes":
    is_windy_inp = input("Is it windy outside? ")
    if is_windy_inp.lower() == "yes":
